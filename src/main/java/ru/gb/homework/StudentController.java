...
public class StudentController {
    ...
    {
        students.add(new Student("Fedor", "Tech writer"));
        students.add(new Student("Alena", "Tester"));
        students.add(new Student("Andrey", "Programmer"));
        students.add(new Student("Knarik", "Designer"));
        students.add(new Student("Svetlana", "Designer"));
        students.add(new Student("Kirill", "Programmer"));
        students.add(new Student("Petr", "CI/CD"));
        students.add(new Student("Petr", "Manager"));
        students.add(new Student("Pavel", "Team leader"));
        students.add(new Student("Sergey", "Tester"));
    }
